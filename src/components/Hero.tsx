        ...
        <div className="flex flex-col items-center text-center">
          ...
          >
            <div className="relative">
              ...
              <div
                className="absolute -inset-4 rounded-full border border-secondary/20 animate-rotate-slow"
                style={{
          ...
          >
            ...
            crafting responsive front-end experiences to developing robust
            back-end systems, I enjoy turning ideas into impactful digital
            products using technologies like React, Next.js, TypeScript,
